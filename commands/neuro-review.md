---
description: Review a neuroimaging manuscript section with the neuro-audit reviewer panel (style, methodology, biology, coherence) + optional editor screen.
...
3. Overlay the runtime `.neuro-audit/` venue + project profiles so reviewers
